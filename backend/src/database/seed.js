...
const sampleProducts = [
  {
    ...
    review_count: 18,
    featured: true,
    description: "Authentic temple-border SiCo Gadwal saree woven with fine SiCo and pure gold zari.",
  },
  {
    ...
    review_count: 14,
    featured: true,
    description: "Rich heritage gold zari motifs woven on opulent royal emerald green SiCo Gadwal.",
  },
  {
    id: "rose-sico-gadwal",
